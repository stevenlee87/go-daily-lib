...
func main() {
	...
	x1, y1, z1 := move("RRRLF", 0, 0, Top) // 0 -1 3 ✅
	//x1, y1, z1 := move("LF", 0, 0, Top) // ✅
	//x1, y1, z1 := move("R2(LF)", 0, 0, Top) // -1 1 0 ✅
	//x1, y1, z1 := move("FFF)", 0, 0, Top) // 0 3 1 // ✅
	//x1, y1, z1 := move("B)", 0, 0, Top) // 0 -1 1 ✅
	//x1, y1, z1 := move("LLB)", 0, 0, Top) // 0 1 3 ✅
	//x1, y1, z1 := move("FFFB)", 0, 0, Top) // 0 2 1 ✅
	//x1, y1, z1 := move("LLFF)", 0, 0, Top) // 0 -2 3 ✅
